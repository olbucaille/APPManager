...
<div class="leftmenubox">
	<ul class="leftmenu">
		<li id="leftmenubox_title"><a id="leftmenu_title" href="#">His/Her Team</a></li>
		...
		<li id="leftmenubox_tab"><a id="leftmenu_ref" href="#">Justin
				Kwan</a></li>
		<li id="leftmenubox_title"><a id="leftmenu_title" href="#">His/Her Tutors</a></li>
		...
		<li id="leftmenubox_title"><a id="leftmenu_title" href="#">His/Her Module Manager</a></li>
		<li id="leftmenubox_tab"><a id="leftmenu_ref" href="#">Manceny</a></li>
	</ul>
</div>
