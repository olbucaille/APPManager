...
<div id="block-central">
	...
	<div
		style="height: 200px; width: 47.2%; float: right; margin: 1% 0 1% 1.6%; display: table;">
		<form action="/APPManager/SControllerAPP" method="POST">
			...
			<br /> <label for="StartDate">Start Date : </label> <input
				type="text" name="StartDate" class="datepicker"> <br />
			<br /> <label for="EndDate">End Date : </label> <input type="text"
				name="EndDate" class="datepicker"> <br />
			<br /> <input type="submit" name="action" value="add APP session"
				name="submit" />
	...
	<div
		...
		<form action="/APPManager/SControllerTeam" method="POST">
			...
			<br /> <label for="TeamName">Team Name : </label> <input type="text"
				name="TeamName"> <br />
			<br /> <label for="APPOfTheTeam">APP Name : </label> <select
				name="APPOfTheTeam" size="1">
			...
			<br /> <input type="submit" name="action" value="add Team session"
				name="submit" />
			...
			<TABLE>
				<TR>
					<TD align="center"><B><FONT size="2">All the User
								by name, id and current status</FONT></B><BR />
					<br /> <select align=top name="liste1" size=15
					...
					<TD align="center"><FONT size="2"><B>User To affect
								and change</B></FONT><BR> <SELECT align=top name="liste2" size=15
						style="width: 250px" multiple="multiple">
