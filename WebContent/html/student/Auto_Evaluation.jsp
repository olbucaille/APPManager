...
<form id="form_eval_auto" name ="form_evaluation" method="post" action="/APPManager/SEvaluation">
	<input id= "evaluationId_auto" type="hidden" name="evaluationId"  value=""/>	
	<%
   			...
   			%>		<tr>
						...
						<fieldset class="rating <%=count%>">
							...
							<input type="radio" id="star2-<%=count%>" name="rating<%=count%>" value="Bof bof" /><label
								...
								id="star1-<%=count%>" name="rating<%=count%>" checked value="Nul" /><label for="star1-<%=count%>"
